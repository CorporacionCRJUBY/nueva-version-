...
const SuperAdminConsolePage = () => {
  ...
  const adminCards = [
    ...
    },
    {
      ...
      path: '/roles',
      color: 'linear-gradient(135deg, #a78bfa 0%, #6d28d9 100%)',
    },
    {
      ...
      path: '/permissions',
      color: 'linear-gradient(135deg, #6d28d9 0%, #1e1b4b 100%)',
    },
    {
    ...
    },
    {
      ...
      path: '/audit',
      color: 'linear-gradient(135deg, #8b5cf6 0%, #1e1b4b 100%)',
    },
    {
      ...
      path: '/activity',
      color: 'linear-gradient(135deg, #7c3aed 0%, #1e1b4b 100%)',
    },
