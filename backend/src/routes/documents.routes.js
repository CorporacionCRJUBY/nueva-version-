...
router.get('/', authorize('documents.view'), validators.findAll, validate, controller.findAll);
...
router.get('/:id/download', authorize('documents.view'), validators.download, validate, controller.download);
router.get('/:id/preview', authorize('documents.view'), validators.download, validate, controller.preview);
