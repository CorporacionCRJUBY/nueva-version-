...
const AssignmentFormPage = () => {
  ...
  // docentes y materias crecen con el uso normal del colegio, así que ahora
  // buscan contra el servidor (AsyncSelect) en vez de traer hasta 1000 filas.
  // Sedes y años académicos SÍ quedan como <Select> con catálogo completo a
  // propósito: son listas estructuralmente chicas (una sede física es un
  // dato que se da de alta pocas veces al año, un año académico es uno por
  // ciclo), no crecen con el número de estudiantes o docentes.
            ...
            <FormSection title={t('assignments.generalInfo')}><FormGrid gap="normal">
                <FormCol size={{ xs: 12, md: 6 }}>
                  <AsyncSelect
                    ...
                    getOptionLabel={(tch) => `${tch.first_name} ${tch.last_name}`}
                  />
                </FormCol>
                <FormCol size={{ xs: 12, md: 6 }}>
                  <AsyncSelect
