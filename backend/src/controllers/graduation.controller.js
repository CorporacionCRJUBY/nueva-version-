...
const create = async (req, res, next) => {
  try {
    const data = await graduationService.create(req.body, req.user, req);
...
const update = async (req, res, next) => {
  try {
    const data = await graduationService.update(req.params.id, req.body, req.user, req);
    res.json({ success: true, data });
  } catch (error) {
    next(error);
  }
...
const softDelete = async (req, res, next) => {
  try {
    await graduationService.softDelete(req.params.id, req.user, req);
...
const validate = async (req, res, next) => {
  try {
    const data = await graduationService.validate(req.params.studentId, req.user, req);
    res.json({ success: true, data });
  } catch (error) {
    next(error);
  }
