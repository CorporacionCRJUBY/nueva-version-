...
const COLOR_MAP = {
  ...
  'text.disabled': '#7c6faa',
  'background.default': '#f5f3ff',
  'background.paper': '#ffffff',
  'action.hover': 'rgba(124,58,237,0.05)',
  'action.selected': 'rgba(124,58,237,0.10)',
  'action.disabled': '#7c6faa',
  divider: '#ddd6fe',
};
...
const academixTheme = {
  ...
  gradientSidebar: `linear-gradient(180deg, ${academixPalette.purple900} 0%, #191241 100%)`,
...
const themeArg = {
  ...
  palette: {
    primary: { main: '#7c3aed', light: '#8b5cf6', dark: '#4c1d95' },
    secondary: { main: '#a78bfa', light: '#c4b5fd', dark: '#7c3aed' },
    background: { default: '#f5f3ff', paper: '#ffffff' },
    text: { primary: '#1e1b4b', secondary: '#6b5b95', disabled: '#7c6faa' },
    divider: '#ddd6fe',
    action: { hover: 'rgba(124,58,237,0.05)', selected: 'rgba(124,58,237,0.10)' },
  },
