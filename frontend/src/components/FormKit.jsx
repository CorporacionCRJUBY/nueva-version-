  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-start gap-3.5">
        ...
        {Icon && (
          <span className="mt-0.5 grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-brand-gradient text-white shadow-brand">
...
export const FormSection = ({
  ...
  <section
    ...
    className={cn(
      'overflow-hidden rounded-xl border border-line bg-surface shadow-sm transition-shadow duration-200 hover:shadow-md',
      className
    )}
  >
    {(title || actions) && (
      <header className="flex flex-wrap items-center justify-between gap-3 border-b border-line bg-gradient-to-r from-brand-50 to-surface px-5 py-4">
...
export const FormActions = ({ children, className, sticky = true, note }) => (
  <div
    ...
    className={cn(
      'flex flex-wrap items-center gap-3 rounded-xl border border-line bg-white/90 px-4 py-3 shadow-md backdrop-blur-sm',
