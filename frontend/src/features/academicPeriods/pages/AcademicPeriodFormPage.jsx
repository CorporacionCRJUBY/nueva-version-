...
const AcademicPeriodFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // FIX (bitácora 2026-09-15): `PUT /api/academic-periods/1` devolvía 400
      // porque se reenviaba el registro entero tal como vino de la BD, y con
      // él `grading_config: null`, que el validador rechazaba. Se manda solo
      // lo editable, con el año como número.
      const payload = {
      ...
      if (isEdit) {
        await academicPeriodsApi.update(id, payload);
      } else {
        await academicPeriodsApi.create(payload);
      }
