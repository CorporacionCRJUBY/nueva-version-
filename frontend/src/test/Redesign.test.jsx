...
// El objeto devuelto debe ser ESTABLE entre renders: el hook real memoiza sus
// funciones (useCallback). Si el mock crea funciones nuevas en cada render, el
// Dashboard vuelve a cargar sus datos en bucle y desmonta los paneles.
