...
const ScholarshipFormPage = () => {
  ...
  const loadOptions = async () => {
    try {
      ...
      // estudiantes ahora busca contra el servidor (AsyncSelect); los años
      // académicos son una lista chica que no crece con el número de
      // estudiantes, así que se queda como <Select> con el catálogo completo.
          ...
          <FormGrid gap="normal">
            <FormCol size={{ xs: 12, md: 6 }}>
              <AsyncSelect
                ...
                getOptionLabel={(s) => `${s.first_name} ${s.last_name} (${s.code})`}
              />
            </FormCol>
            <FormCol size={{ xs: 12, md: 6 }}>
