...
/** Página 404. Migrada a Tailwind CSS. */
const NotFoundPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-hero-gradient p-6">
      ...
      <div className="relative w-full max-w-lg animate-scale-in rounded-2xl border border-line bg-surface p-10 text-center shadow-xl">
        <div className="gradient-text font-display text-[96px] font-black leading-none opacity-85">404</div>
        <h1 className="mb-2 font-display text-2xl font-extrabold text-ink">{t('notFound.title')}</h1>
        <p className="mb-7 text-sm text-ink-soft">{t('notFound.message')}</p>
