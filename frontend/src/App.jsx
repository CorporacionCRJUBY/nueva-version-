...
import { AssignmentListPage, AssignmentFormPage, MyGroupsPage } from './features/assignments';
...
// #7c3aed como acento de acción. Los nombres se conservan porque todo el tema
  ...
  components: {
    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          ...
          '&.Mui-focused': { boxShadow: '0 0 0 3px rgba(124,58,237,0.14)' },
          ...
          '&.Mui-disabled': { backgroundColor: '#f5f3ff' },
        },
    ...
    MuiAutocomplete: {
      styleOverrides: {
        ...
        option: {
          fontSize: '0.875rem',
          '&[aria-selected="true"]': { backgroundColor: 'rgba(124,58,237,0.10)' },
        },
      },
    },
    MuiCheckbox: {
      ...
      styleOverrides: {
        root: {
          ...
          '&.Mui-selected': {
            ...
            '&:hover': { backgroundColor: 'rgba(124,58,237,0.45)' },
          },
          '&:hover': {
    ...
    MuiMenuItem: {
      styleOverrides: {
        root: {
          ...
          '&.Mui-selected': { backgroundColor: 'rgba(124,58,237,0.1)' },
        },
      },
    },
    MuiAlert: {
              ...
              <Route element={<ProtectedRoute />}>
                <Route element={<MainLayout />}>
                  ...
                  <Route element={<ProtectedRoute permission="assignments.view" />}>
                    ...
                    {/* FIX (2026-09-16, autoasignación de materias): el docente busca su
                        grupo y se autoasigna la materia + horario, en vez de esperar a
                        que administración le cree la asignación a mano. */}
                    <Route path="/assignments/my-groups" element={<MyGroupsPage />} />
